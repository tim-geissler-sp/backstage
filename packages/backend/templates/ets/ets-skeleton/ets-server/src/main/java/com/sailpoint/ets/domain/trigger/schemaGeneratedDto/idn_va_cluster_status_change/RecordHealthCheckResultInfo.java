...
public class RecordHealthCheckResultInfo {
    ...
    public String toString() {
        ...
        sb.append(RecordHealthCheckResultInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordHealthCheckResultInfo) == false) {
            return false;
        }
        RecordHealthCheckResultInfo rhs = ((RecordHealthCheckResultInfo) other);
