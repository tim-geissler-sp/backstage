...
package com.sailpoint.ets.domain.trigger.schemaGeneratedDto.idn_source_account_deleted;
...
public class RecordSourceAccountDeletedEvent {
    ...
    public String toString() {
        ...
        sb.append(RecordSourceAccountDeletedEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uuid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordSourceAccountDeletedEvent) == false) {
            return false;
        }
        RecordSourceAccountDeletedEvent rhs = ((RecordSourceAccountDeletedEvent) other);
