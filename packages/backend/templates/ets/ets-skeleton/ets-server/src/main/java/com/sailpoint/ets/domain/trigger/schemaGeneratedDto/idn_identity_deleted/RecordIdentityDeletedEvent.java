...
package com.sailpoint.ets.domain.trigger.schemaGeneratedDto.idn_identity_deleted;
...
public class RecordIdentityDeletedEvent {
    ...
    public String toString() {
        ...
        sb.append(RecordIdentityDeletedEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("identity");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordIdentityDeletedEvent) == false) {
            return false;
        }
        RecordIdentityDeletedEvent rhs = ((RecordIdentityDeletedEvent) other);
