...
public class RecordAccessRequestDynamicApproverInput {
    ...
    private RecordRequestedForIdentityRef requestedFor;
    /**
     * 
     * (Required)
     * 
    ...
    private RecordRequestedByIdentityRef requestedBy;
     ...
     */
    @JsonProperty("requestedFor")
    public RecordRequestedForIdentityRef getRequestedFor() {
        return requestedFor;
    }
     ...
     */
    @JsonProperty("requestedFor")
    public void setRequestedFor(RecordRequestedForIdentityRef requestedFor) {
     ...
     */
    @JsonProperty("requestedBy")
    public RecordRequestedByIdentityRef getRequestedBy() {
        return requestedBy;
    }
     ...
     */
    @JsonProperty("requestedBy")
    public void setRequestedBy(RecordRequestedByIdentityRef requestedBy) {
    ...
    public String toString() {
        ...
        sb.append(RecordAccessRequestDynamicApproverInput.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordAccessRequestDynamicApproverInput) == false) {
            return false;
        }
        RecordAccessRequestDynamicApproverInput rhs = ((RecordAccessRequestDynamicApproverInput) other);
