...
public class RecordCampaignGeneratedPayload {
    ...
    public String toString() {
        ...
        sb.append(RecordCampaignGeneratedPayload.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("campaign");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordCampaignGeneratedPayload) == false) {
            return false;
        }
        RecordCampaignGeneratedPayload rhs = ((RecordCampaignGeneratedPayload) other);
