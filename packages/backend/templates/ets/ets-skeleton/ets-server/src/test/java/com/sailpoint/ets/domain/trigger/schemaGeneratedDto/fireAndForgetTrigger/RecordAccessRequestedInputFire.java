package com.sailpoint.ets.domain.trigger.schemaGeneratedDto.fireAndForgetTrigger;
...
public class RecordAccessRequestedInputFire {
	...
	public String toString() {
		...
		sb.append(RecordAccessRequestedInputFire.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
		sb.append("approved");
		sb.append('=');
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof RecordAccessRequestedInputFire) == false) {
			return false;
		}
		RecordAccessRequestedInputFire rhs = ((RecordAccessRequestedInputFire) other);
