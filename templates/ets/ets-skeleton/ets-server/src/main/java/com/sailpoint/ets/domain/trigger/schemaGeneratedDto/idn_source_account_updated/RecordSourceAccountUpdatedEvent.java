...
package com.sailpoint.ets.domain.trigger.schemaGeneratedDto.idn_source_account_updated;
...
public class RecordSourceAccountUpdatedEvent {
    ...
    public String toString() {
        ...
        sb.append(RecordSourceAccountUpdatedEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uuid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordSourceAccountUpdatedEvent) == false) {
            return false;
        }
        RecordSourceAccountUpdatedEvent rhs = ((RecordSourceAccountUpdatedEvent) other);
