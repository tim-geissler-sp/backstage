...
func newIdnTopicRegistry() *idnTopicRegistry {
	return &idnTopicRegistry {
		...
		ACCOUNTS: event.NewSimpleTopicDescriptor(event.TopicScopePod, "accounts"),
		AGGREGATION_HISTORY: event.NewSimpleTopicDescriptor(event.TopicScopePod, "aggregation_history"),
		ATTRIBUTE_PROMOTION: event.NewSimpleTopicDescriptor(event.TopicScopePod, "attribute_promotion"),
		...
		BIR_DASHBOARD: event.NewSimpleTopicDescriptor(event.TopicScopePod, "bir_dashboard"),
		...
		CONNECTOR: event.NewSimpleTopicDescriptor(event.TopicScopePod, "connector"),
		...
		SEARCH_ACTION: event.NewSimpleTopicDescriptor(event.TopicScopePod, "search_action"),
		SEGMENT: event.NewSimpleTopicDescriptor(event.TopicScopePod, "segment"),
		...
		UPDATED_COMPOSITE_ENTITLEMENT: event.NewSimpleTopicDescriptor(event.TopicScopePod, "updated_composite_entitlement"),
		UPDATED_COMPOSITE_IDENTITY: event.NewSimpleTopicDescriptor(event.TopicScopePod, "updated_composite_identity"),
		WORKFLOW: event.NewSimpleTopicDescriptor(event.TopicScopePod, "workflow"),
	}
}
...
type idnTopicRegistry struct {
	...
	ACCOUNTS event.TopicDescriptor
	AGGREGATION_HISTORY event.TopicDescriptor
	ATTRIBUTE_PROMOTION event.TopicDescriptor
	AUDIT event.TopicDescriptor
	AUTHENTICATION event.TopicDescriptor
	BIR_DASHBOARD event.TopicDescriptor
	...
	CONNECTOR event.TopicDescriptor
	...
	SEARCH_ACTION event.TopicDescriptor
	SEGMENT event.TopicDescriptor
	...
	UPDATED_COMPOSITE_ENTITLEMENT event.TopicDescriptor
	UPDATED_COMPOSITE_IDENTITY event.TopicDescriptor
	WORKFLOW event.TopicDescriptor
}
